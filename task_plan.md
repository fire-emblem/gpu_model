...
## 目标
将当前项目收口到 `HipRuntime / ModelRuntime / ExecEngine` 三个清晰概念，完成门禁轻量化和关键文档同步，并继续清理剩余历史命名与产物噪音。
...
| 暂不系统清理 docs 历史 plans/spec 中的旧命名 | 历史存档优先保留原始上下文，当前先保证主代码与主文档口径一致 |
