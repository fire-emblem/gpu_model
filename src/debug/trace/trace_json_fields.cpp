...
void AppendTraceExportJsonFields(std::ostringstream& out,
  ...
  AppendOptionalTraceJsonStringField(out, "arrive_progress", fields.arrive_progress);
  ...
  AppendOptionalTraceJsonStringField(out, "waitcnt_pending_before",
                                     fields.waitcnt_pending_before);
  AppendOptionalTraceJsonStringField(out, "waitcnt_pending", fields.waitcnt_pending);
  AppendOptionalTraceJsonStringField(out, "waitcnt_pending_transition",
                                     fields.waitcnt_pending_transition);
