...
enum class GcnOpTypeEncoding : uint16_t {
  Unknown = 0xffff,
  VOP2 = 0x0,
  SOP2 = 0x2,
  SOPK = 0xb,
...
enum class GcnSop2Opcode : uint16_t {
  S_AND_B32 = 12,
  S_MUL_I32 = 36,
  S_ADD_I32 = 2,
  S_OR_B64 = 15,
...
enum class GcnSop1Opcode : uint16_t {
...
enum class GcnSopkOpcode : uint16_t {
  S_MOVK_I32 = 0,
};
...
struct GcnOpcodeDescriptor {
  GcnOpTypeEncoding op_type = GcnOpTypeEncoding::Unknown;
  uint16_t opcode = 0;
