...
KernelProgram BuildVecAddKernelForScaling() {
...
KernelProgram BuildFmaLoopKernelForScaling() {
  InstructionBuilder builder;
  builder.SLoadArg("s0", 0);
  builder.SLoadArg("s1", 1);
  builder.SLoadArg("s2", 2);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        LaunchShape{.grid_dim_x = 64, .block_dim_x = 1},
        LaunchShape{.grid_dim_x = 104, .block_dim_x = 1},
        LaunchShape{.grid_dim_x = 1024, .block_dim_x = 1},
        LaunchShape{.grid_dim_x = 1, .block_dim_x = 60},
        LaunchShape{.grid_dim_x = 64, .block_dim_x = 60},
        LaunchShape{.grid_dim_x = 104, .block_dim_x = 60},
        LaunchShape{.grid_dim_x = 1024, .block_dim_x = 60},
        LaunchShape{.grid_dim_x = 1, .block_dim_x = 64},
        LaunchShape{.grid_dim_x = 64, .block_dim_x = 64},
        LaunchShape{.grid_dim_x = 104, .block_dim_x = 64},
        LaunchShape{.grid_dim_x = 1024, .block_dim_x = 64},
        ...
        LaunchShape{.grid_dim_x = 104, .block_dim_x = 128},
        LaunchShape{.grid_dim_x = 1024, .block_dim_x = 128},
        LaunchShape{.grid_dim_x = 1, .block_dim_x = 1024},
        LaunchShape{.grid_dim_x = 64, .block_dim_x = 1024},
        LaunchShape{.grid_dim_x = 104, .block_dim_x = 1024},
