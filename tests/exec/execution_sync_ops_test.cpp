...
TEST(ExecutionSyncOpsTest, ReleasesBarrierThroughWavePointers) {
  ...
  uint32_t arrivals = 0;
  execution_sync_ops::MarkWaveAtBarrier(owned_waves[0], generation, arrivals, true);
  execution_sync_ops::MarkWaveAtBarrier(owned_waves[1], generation, arrivals, true);
