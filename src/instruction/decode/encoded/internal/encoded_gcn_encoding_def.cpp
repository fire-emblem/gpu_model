...
constexpr EncodedGcnEncodingDef kManualEncodedGcnEncodingDefs[] = {
    ...
    EncodedGcnEncodingDef{.id = 125,
                          ...
                          .size_bytes = 4,
                          .mnemonic = "s_max_i32"},
    EncodedGcnEncodingDef{.id = 135,
                          .format_class = EncodedGcnInstFormatClass::Sop2,
                          .op = 0x07,
                          .size_bytes = 4,
                          .mnemonic = "s_min_u32"},
    EncodedGcnEncodingDef{.id = 136,
                          .format_class = EncodedGcnInstFormatClass::Sop2,
                          .op = 0x09,
                          .size_bytes = 4,
                          .mnemonic = "s_max_u32"},
...
constexpr DecoderOverrideEntry kDecoderOverrides[] = {
    ...
    {"s_ff1_i32_b32", EncodedOperandDecoderKind::Sop1Scalar},
    ...
    {"s_max_u32", EncodedOperandDecoderKind::Sop2Scalar},
    {"s_min_i32", EncodedOperandDecoderKind::Sop2Scalar},
    {"s_min_u32", EncodedOperandDecoderKind::Sop2Scalar},
