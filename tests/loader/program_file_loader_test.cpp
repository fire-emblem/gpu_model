...
TEST(ProgramFileLoaderTest, LoadsProgramImageFromFilesAndLaunchesIt) {
  const std::filesystem::path dir =
      std::filesystem::temp_directory_path() / "gpu_model_program_file_loader_test";
  ...
  const ProgramImage image = ProgramFileLoader{}.LoadFromStem(asm_path);
