...
FOCUSED_FILTER+='HipLdPreloadTest.LaunchesHipSharedReverseExecutableThroughRegisteredHostFunction:'
FOCUSED_FILTER+='HipLdPreloadTest.LaunchesHipDynamicSharedExecutableThroughRegisteredHostFunction:'
FOCUSED_FILTER+='HipLdPreloadTest.LaunchesHipBlockReduceExecutableThroughRegisteredHostFunction:'
FOCUSED_FILTER+='HipLdPreloadTest.LaunchesHipSoftmaxExecutableThroughRegisteredHostFunction:'
...
CTS_FILTER+='HipRuntimeCTS/*:HipLdPreloadCTS/*:HipRuntimeFeatureCTS/*:HipLdPreloadFeatureCTS/*'
...
[shared-heavy] ok
- focused decode/hip-ld-preload/runtime/parallel ring passed
