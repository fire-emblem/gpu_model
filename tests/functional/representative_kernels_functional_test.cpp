...
ExecutableKernel BuildStencil1DKernel() {
  InstructionBuilder builder;
  builder.SLoadArg("s0", 0);
  builder.SLoadArg("s1", 1);
  builder.SLoadArg("s2", 2);
...
ExecutableKernel BuildBlockReductionKernel() {
  ...
  builder.BExit();
  return builder.Build("block_reduction");
}
...
ExecutableKernel BuildStencil2DKernel() {
  ...
  builder.MaskRestoreExec("s10");
  builder.BExit();
  return builder.Build("stencil_2d");
}
...
TEST(RepresentativeFunctionalKernelsTest, BlockReductionProducesPerBlockSums) {
...
TEST(RepresentativeFunctionalKernelsTest, Stencil2DProducesFivePointSums) {
